    ...
    children=html.Div(
        children=[
            ...
            html.P(
                ...
                different omic data analysis workflows including a graphical
                user interface (GUI), but also as a standalone Python package
                that users can integrate into their existing pipelines.''',
                style={
                    'text-align': 'justify',
                    'padding-right': 20
                }
